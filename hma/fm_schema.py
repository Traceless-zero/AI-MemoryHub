...
def render_fm(d, body, filepath=None):
    ...
    # render_fm 仅做 front-matter 序列化展示（不落盘），解除状态锁放行。
    # 不走 mark_as_complete（body 可能为空，且本路径无覆盖风险）。
