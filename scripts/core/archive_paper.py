...
用法：
  python scripts/core/archive_paper.py orig <src.md> <memory_root> <pkg_rel> <id> <title> <summary> <tags_csv> [<aliases_csv>]
  python scripts/core/archive_paper.py review <review.md> <memory_root> <pkg_rel> <id> <title> <summary> <tags_csv> [<aliases_csv>]

例：
  python scripts/core/archive_paper.py orig "E:/BaiduNetdiskDownload/尼采.md" memory "Other/哲学/尼采" \
      nietzsche-orig "弗里德里希·尼采：哲学思想综述与理解" \
      "尼采思想综述：上帝之死/权力意志/超人/永恒轮回（用户个人记录）" "paper,哲学,尼采"
  python scripts/core/archive_paper.py review /tmp/nietzsche-review.md memory "Other/哲学/尼采" \
