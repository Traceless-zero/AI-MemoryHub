...
用法：
    python scripts/core/relocate_package.py <memory_root> <旧包相对路径> <新包相对路径>
    python scripts/core/relocate_package.py <memory_root> <源包相对路径> <目标包相对路径> --merge
例：
    python scripts/core/relocate_package.py memory "其他/哲学/有限空间必然趋同" "其他/科学/复杂系统/有限空间必然趋同"
    python scripts/core/relocate_package.py memory "其他/哲学/尼采2" "其他/哲学/尼采" --merge
